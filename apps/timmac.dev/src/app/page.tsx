    ...
    <MainLayout>
      ...
      <Content cta ctaText="Learn More" ctaLink="/about">
        ...
        <span className="italic">
          ...
          <strong className="underline">stunning website</strong> that Timmac
          created for us. It was exactly what we had envisioned, and it has
          helped us to generate{" "}
          <strong className="underline">more leads</strong> than ever
          before.&quot;
        </span>
      </Content>
      <ScrollingBanner baseVelocity={-3}>Casestudies</ScrollingBanner>
      <Casestudy
      ...
      <Content cta ctaText="More Casestudies" ctaLink="/casestudies">
        ...
        <span className="italic">
          &quot;Our Shopify Store was growing slowly. However, after Timmac made
          us a dedicated landing page for our best selling product, we saw a{" "}
